...
@Bot.on_message(filters.command('start') & filters.private & subsCH_VI  & subsCH_V  & subsCH_IV & subsCH_III & subsCH_II & subsCH_I)
    ...
    if len(text)>7:
        ...
        if len(argument) == 3:
            ...
            try:
                ...
                return
        temp_msg = await message.reply("Tunggu Sebentar Mas Pacar...")
        try:
